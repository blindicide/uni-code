...
# Проверка установки tabulate, вывод инструкций при отсутствии
try:
    from tabulate import tabulate
except ImportError:
    print("Ошибка: Модуль 'tabulate' не найден.")
    print("Пожалуйста, установите его, выполнив команду:")
    print("pip install tabulate")
    sys.exit(1) # Выход, если необходимая библиотека отсутствует

SERVER_HOST = '127.0.0.1'
SERVER_PORT = 65432 # Должен совпадать с портом сервера
